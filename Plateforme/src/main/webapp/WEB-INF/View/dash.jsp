    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="annonces" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
          ...
          <!-- Main row -->
          <div class="row">
			<center><h1 class="slogan">Le sport commence ici</h1></center>
			<img src="${pageContext.request.contextPath}/resources/dist/img/background.png"  style="width:100%;"/>
		  </div><!-- /.row (main row) -->
