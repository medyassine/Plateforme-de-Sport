		 ...
		 <div class="title">
          ...
          <div class="row">
				...
				<div class="col-lg-3 col-xs-6">
					<a class="btn btn-block btn-primary btn-lg" href="addannonce"><i class="fa fa-plus"></i> Ajouter une annonce</a>
				</div>
						
          </div><!-- /.row -->
          <br/>
          
		<c:forEach items="${annonces}" var="tipo">
			  ...
			  <div class="col-md-4">
					...
					<div class="widget-user-header bg-yellow">
					  <div class="widget-user-image">
						<img class="img-circle" src="${pageContext.request.contextPath}/resources/dist/img/${tipo.jeu}.png" alt="User Avatar">
					  </div><!-- /.widget-user-image -->
					  <h3 class="widget-user-username">${tipo.titre}</h3>
					  <h5 class="widget-user-desc">le ${tipo.date} à  ${tipo.lieu}</h5>
					</div>
					<div class="box-footer no-padding">
					  <ul class="nav nav-stacked">
						<li>${tipo.description}</li>
						<li><a href="delannonce/${tipo.idAnnonce}"><i class="fa fa-trash-o"></i><span style="margin-left: 10px;">Supprimer l'annonce </span></a></li>
					  </ul>
					</div>
				  </div><!-- /.widget-user -->
