    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.html" class="logo">
          ...
          <span class="logo-mini"><b>Sp</b>M</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Sports</b>Meeting</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
			...
			<input class="search_friend" placeholder="Rechercher des amis,des évènement ...">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="deconnecter" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="index.html">
                <i class="fa fa-dashboard"></i> <span>Fils d'actualité</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-bullhorn"></i> <span>Les évènement actuel</span>
              </a>
            </li>
...
<!-- Main content -->
		...
		<center>
			...
			<form:form action="addannonce"  commandName="annonce">
			<table>
				<tr>
					<td>Titre :<FONT color="red"><form:errors
						path="titre" /></FONT></td>
				</tr>
				<tr>
					<td><form:input path="titre" cssClass="form-control" /></td>
				</tr>
				<tr>
					<td>Description :<FONT color="red"><form:errors
						path="description" cssClass="form-control"/></FONT></td>
				</tr>
				<tr>
					<td><form:textarea path="description" cssClass="form-control" /></td>
				</tr>
				<tr>
					<td>Date :<FONT color="red"><form:errors
						path="date" /></FONT></td>
				</tr>
				<tr>
					<td><form:input path="date" cssClass="form-control"/></td>
				</tr>
				<tr>
					<td>Lieu :<FONT color="red"><form:errors
						path="lieu" /></FONT></td>
				</tr>
				<tr>
					<td><form:input path="lieu" cssClass="form-control"/></td>
				</tr>
				<tr>
					<td>Jeu :<FONT color="red"><form:errors
						path="date" /></FONT></td>
				</tr>
				<tr>
					<td><form:select path="jeu" cssClass="form-control">
							...
							<form:option value="Vollet">‎Volley</form:option>
						</form:select></td>
				</tr>
				
				<tr>
					<td><br><input type="submit" value="Submit" cssClass="form-control" /></td>
				</tr>
			</table>
		</form:form>
    ...
    <hr/>
      ...
      <aside class="control-sidebar control-sidebar-dark">
        ...
        <div class="tab-content">
				...
				<a href="#"><i class="fa fa-wrench"></i><span style="margin-left:20px;">Modifier le profil<span></a>
