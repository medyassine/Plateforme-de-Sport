...
<!-- Main content -->
		...
		<center>
			...
			<h5>Cree Groupe</h5>
			<form:form action="addgroupe"  commandName="groupe">
			<table>
				<tr>
					<td>Intitulé :<FONT color="red"><form:errors
						path="intitule" /></FONT></td>
				</tr>
				<tr>
					<td><form:input path="intitule" class="form-control"/></td>
				</tr>
				<tr>
					<td>Taille :<FONT color="red"><form:errors
						path="taille" /></FONT></td>
				</tr>
				<tr>
					<td><form:input path="taille" class="form-control" /></td>
				</tr>
